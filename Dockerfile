...
ENV VITE_FIREBASE_AUTH_DOMAIN=stillwater-sovereign-01.firebaseapp.com
ENV VITE_FIREBASE_PROJECT_ID=stillwater-sovereign-01
ENV VITE_FIREBASE_STORAGE_BUCKET=stillwater-sovereign-01.firebasestorage.app
