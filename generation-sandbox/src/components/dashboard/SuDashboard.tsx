...
import OperatingPrinciples from '@/components/dashboard/OperatingPrinciples';
...
export default function SuDashboard({ dashboardData }: SuDashboardProps) {
    ...
    const {
        ...
        handleUpdatePrinciples, ecosystemStatus
    } = dashboardData;
        ...
        <div className="min-h-screen">
            ...
            <main className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    { !statusLoading && (
                        <div className="md:col-span-3 flex justify-end mt-[-16px]">
                            <div className="flex items-center gap-2 px-3 py-1 bg-background-secondary/50 rounded-full border border-border/50">
                                <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                <span className="text-[8px] font-black uppercase tracking-widest text-foreground-muted">Live System Heartbeat</span>
                            </div>
                        </div>
                    )}
                </div>
                ...
                {isAdmin && (
                    <OperatingPrinciples 
                        ...
                        onUpdate={handleUpdatePrinciples} 
                    />
                )}
